...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        String[] selargs={locationSetting,cityName,lat+"",lon+""};
        ...
        //Cursor cursor=resolver.query(WeatherContract.LocationEntry.CONTENT_URI, null, selection, selargs, null);
        ...
        if(locationCursor.moveToFirst())
          id=locationCursor.getLong(locationCursor.getColumnIndex(WeatherContract.LocationEntry._ID));
            ...
            uri = resolver.insert(WeatherContract.LocationEntry.CONTENT_URI, values);
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                provider.bulkInsert(WeatherEntry.CONTENT_URI,(ContentValues[])cVVector.toArray());
            }
